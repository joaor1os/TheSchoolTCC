...
CREATE TABLE `notas_aluno` (
  ...
  `disciplina_na` int(11) NOT NULL,
  `nota_na` int(11) NOT NULL,
  `bimestre_na` int(11) NOT NULL,
  `nota1` float DEFAULT NULL,
  `nota2` float DEFAULT NULL,
  `nota3` float DEFAULT NULL,
  `media` float DEFAULT NULL,
  PRIMARY KEY (`id_na`),
  KEY `disciplina_na` (`disciplina_na`),
  CONSTRAINT `notas_aluno_ibfk_1` FOREIGN KEY (`disciplina_na`) REFERENCES `professor` (`disciplina_professor`)
